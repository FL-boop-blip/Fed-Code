...
if __name__ == '__main__':
    root_dir_train = r"../Data/Raw/fer2013_plus/train"
    root_dir_test = r"../Data/Raw/fer2013_plus/test"
    root_dir_val = r"../Data/Raw/fer2013_plus/val"
    ...
    train_set = Fer2013_plus(root_dir_train, transform=transform)
    test_set = Fer2013_plus(root_dir_test, transform=transform)
    valid_set = Fer2013_plus(root_dir_val, transform=transform)
